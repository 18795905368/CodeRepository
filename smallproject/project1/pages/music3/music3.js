...
Page({
   ...
   */
  data: {
    bgimgpath: app.globalData.serveraddress + "/images/music/musicbg7.jpg",
    playpath: "",
    topviewdatas: { "imgpath": app.globalData.serveraddress + "/images/music/3.jpg", "name": "薛之谦那些歌" },
    musicdatas: [],
    nginx:"",
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: app.globalData.serveraddress +'/text/music3.json',
