...
Page({
   ...
   */
  data: {
    bgimgpath: app.globalData.serveraddress + "/images/music/musicbg6.jpg",
    topviewdatas: { "imgpath": app.globalData.serveraddress + "/images/music/2.jpg", "name": "一首陈奕迅 一首周杰伦" },
    playpath: "",
    musicdatas: [],
    nginx:"",
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: app.globalData.serveraddress + '/text/music2.json',
